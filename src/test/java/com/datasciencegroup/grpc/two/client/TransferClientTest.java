...
public class TransferClientTest {
    ...
    public void transfer() throws InterruptedException {
        ...
        // this is the client side response observer that we have to pass to the stub method
        TransferStreamingResponse response = new TransferStreamingResponse(latch);
        // the stub is expecting the response observer, which returns the server-side request stream observer
